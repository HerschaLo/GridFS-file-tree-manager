...
class MongoFileTree {
    ...
    constructor(mongoConnectionUrl, dbName, bucketName, folderCollectionName) {
        ...
        this._bucket = new mongodb_1.GridFSBucket(this._client.db(dbName), { bucketName: bucketName });
    ...
    createFolder(folderName, customMetadata) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                let path = this.currentWorkingDirectory + `/${folderName}`;
                let doesFolderExist = Boolean(yield this._db.collection(this._folderCollectionName).findOne({ "path": path }));
                if (doesFolderExist) {
                ...
                let result = yield this._db.collection(this._folderCollectionName).insertOne({ name: folderName, path: path, parentDirectory: this.currentWorkingDirectory, customMetadata: Object.assign({}, customMetadata) });
                resolve(result);
            }));
        }));
    }
    ...
    getFileReadStream(filePath) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                let file = (yield this._bucket.find({ "metadata.path": filePath, "metadata.isLatest": true }).toArray())[0];
                if (!file) {
    ...
    downloadFolder(folderPath, returnType) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                let folderZip = new jszip_1.default();
                ...
                let topFolder = yield this._db.collection(this._folderCollectionName).findOne({ "path": folderPath });
                ...
                let allFiles = yield this._bucket.find({ "metadata.isLatest": true, "metadata.parentDirectory": new RegExp("^" + folderPath) }).toArray();
                for (let i = 0; i < allFiles.length; i++) {
                    yield downloadAsync(allFiles[i]);
                }
        ...
        return new Promise((resolve, reject) => {
            ...
            this._client.connect(() => {
                ...
                let uploadStream = this._bucket.openUploadStream(options.name, {
                    ...
                    metadata: Object.assign({ parentDirectory: this.currentWorkingDirectory, path: path, isLatest: true }, options.customMetadata)
                });
    ...
    changeFileName(newName, filePath) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                ...
                let parentDirectory = (_b = (_a = (yield allFileVersions.next())) === null || _a === void 0 ? void 0 : _a.metadata) === null || _b === void 0 ? void 0 : _b.parentDirectory;
    ...
    changeFolderName(newName, folderPath) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                ...
                let doesFolderExist = Boolean(yield this._db.collection(this._folderCollectionName).findOne({ "path": (topFolder === null || topFolder === void 0 ? void 0 : topFolder.parentDirectory) + `/${newName}` }));
                if (doesFolderExist) {
    ...
    changeDirectory(path, isRelative = false) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                ...
                let folder = yield this._db.collection(this._folderCollectionName).findOne({ "path": absolutePath });
    ...
    deleteFolder(folderPath) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                ...
                let allFiles = yield this._bucket.find({ "metadata.isLatest": true, "metadata.parentDirectory": new RegExp("^" + folderPath) }).toArray();
                for (let i = 0; i < allFiles.length; i++) {
                    yield this.deleteFile((_a = allFiles[i].metadata) === null || _a === void 0 ? void 0 : _a.path);
                }
    ...
    deleteFile(filePath) {
        return new Promise((resolve, reject) => {
            this._client.connect(() => __awaiter(this, void 0, void 0, function* () {
                ...
                let allFileVersionsArr = yield allFileVersions.toArray();
                for (let i = 0; i < allFileVersionsArr.length; i++) {
                    yield this._bucket.delete(allFileVersionsArr[i]._id);
                }
                resolve();
            }));
        });
